...
/// </summary>
public class DbMaintenanceServiceScoped
{
    private readonly DbPropertiesScoped _dbProperties;
    private readonly SqlProvider _sqlProvider;

    public DbMaintenanceServiceScoped(DbPropertiesScoped dbProperties,
